...
Identify maximum profit margin sub-categories

Analyze monthly sales trends over time

Compare profit vs. quantity sold using scatter visualization
...
Highlighted sub-categories with highest profit margins

Detected seasonal sales patterns using time-series analysis

Revealed low-profit high-quantity products for optimization
